...
$(document).ready(function () {
    ...
    function addServiceRow(asociadoId, selectedId, firstId) {
        ...
        var closeButton = '';
        if(asociadoId != firstId){
            closeButton = `<button type="button" class="remove-service btn btn-danger btn-sm" data-asociado-id="${asociadoId}">X</button>`;
        }
        var row = `
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                data.forEach(service => {
                    ...
                    : ""; // Si no es editable, no pone botón
                    costosContainer.append(`
