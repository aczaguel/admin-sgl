...
defined('SGL_TRA_STATUS_EVIDENCIAS_FINALES') || define('SGL_TRA_STATUS_EVIDENCIAS_FINALES', 30);
defined('SGL_TRA_STATUS_EVIDENCIAS_APROBADAS') || define('SGL_TRA_STATUS_EVIDENCIAS_APROBADAS', 31);
...
defined('SGL_TRA_STATUS_IDS') || define('SGL_TRA_STATUS_IDS', [
	...
	'evidencias_finales' => SGL_TRA_STATUS_EVIDENCIAS_FINALES,
	'evidencias_aprobadas' => SGL_TRA_STATUS_EVIDENCIAS_APROBADAS,
]);
...
defined('SGL_TRA_STATUS_EDIT_STAGE_MAP') || define('SGL_TRA_STATUS_EDIT_STAGE_MAP', [
	SGL_TRA_STATUS_SOLICITUD => 1,
	SGL_TRA_STATUS_RECOLECCION_DCTOS => 1,
	SGL_TRA_STATUS_COTIZACION => 1,
	...
	SGL_TRA_STATUS_EVIDENCIAS_FINALES => 3,
	SGL_TRA_STATUS_EVIDENCIAS_APROBADAS => 4,
