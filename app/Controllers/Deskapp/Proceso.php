...
class Proceso extends BaseController
{
    ...
    public function concluido($id) {
        ...
        $crudevidencias->setApiUrlPath('/deskapp/proceso/concluido_evidencias/'.$id);
        $outputevidencias = $crudevidencias->render();

        $crudevidencias_finales = $this->_getGroceryCrudEnterprise();
        $crudevidencias_finales->setApiUrlPath('/deskapp/proceso/concluido_evidencias_finales/' . $id);
        $outputevidencias_finales = $crudevidencias_finales->render();
        
        $crud_derechos = $this->_getGroceryCrudEnterprise();
        $crud_derechos->setApiUrlPath('/deskapp/proceso/concluido_pago_derechos/' . $id);
        ...
        return $this->_example_output_2($form, 'concluido');
    }
