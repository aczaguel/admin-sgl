				...
				<div class="container px-0">
					...
					<div class="row">
						<div class="col-md-4 mb-30">
							<div class="card-box pricing-card mt-30 mb-30">
								<div class="pricing-icon">
									<img src="<?php echo base_url(); ?>/public/assets/vendors/images/icon-Cash.png" alt="">
								</div>
						...
						<div class="col-md-4 mb-30">
							<div class="card-box pricing-card mt-30 mb-30">
								<div class="pricing-icon">
									<img src="<?php echo base_url(); ?>/public/assets/vendors/images/icon-debit.png" alt="">
								</div>
								<div class="price-title">
									expert
								</div>
						...
						<div class="col-md-4 mb-30">
							<div class="card-box pricing-card mt-30 mb-30">
								<div class="pricing-icon">
									<img src="<?php echo base_url(); ?>/public/assets/vendors/images/icon-online-wallet.png" alt="">
								</div>
								<div class="price-title">
									experience
								</div>
