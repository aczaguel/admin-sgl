...
<head>
	...
	<link rel="stylesheet" href="/public/assets/src/styles/dropzone.css">
	<!-- jQuery Steps CSS -->
...
?>
	...
	<script src="<?php echo base_url(); ?>/public/assets/src/scripts/dropzone.js?v=<?php echo time(); ?>"></script>
