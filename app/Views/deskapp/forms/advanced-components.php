...
<head>
	...
	<!-- switchery css -->
	<link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>/public/assets/src/plugins/switchery/switchery.min.css">
	<!-- bootstrap-tagsinput css -->
	<link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>/public/assets/src/plugins/bootstrap-tagsinput/bootstrap-tagsinput.css">
...
<body>
	...
	<!-- switchery js -->
	<script src="<?php echo base_url(); ?>/public/assets/src/plugins/switchery/switchery.min.js"></script>
	<!-- bootstrap-tagsinput js -->
	<script src="<?php echo base_url(); ?>/public/assets/src/plugins/bootstrap-tagsinput/bootstrap-tagsinput.js"></script>
	<!-- bootstrap-touchspin js -->
	<script src="<?php echo base_url(); ?>/public/assets/src/plugins/bootstrap-touchspin/jquery.bootstrap-touchspin.js"></script>
	<script src="<?php echo base_url(); ?>/public/assets/vendors/scripts/advanced-components.js"></script>
</body>
</html>